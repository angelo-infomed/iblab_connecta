...
public class BasePage {
	...
	public String logingConnecta(String login){
		...
		switch (aux){
			...
			case "ADMIN":
				...
				return admin;
			case "AUTOPREST":
				String autoprest = "autoprest";
				return autoprest;
			case "AUTOAUDITM":
				String autoauditm = "autoauditm";
				return autoauditm;
			case "AUTOAUDITE":
				String autoaudite = "autoaudite";
				return autoaudite;
			case "AUTOADITA":
				String autoaudita  = "autoaudita ";
				return autoaudita ;
	}
		return aux;
	}
	...
	public void deselecionarCombo(By by, String valor) {
		WebElement element = DriverFactory.getDriver().findElement(By.id(valor));
		Select combo = new Select(element);
